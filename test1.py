...
##url2 = 'http://fedexdev01.service-now.com/api/x_hclfe_cmdb_api/hardware/by_ip?ip_address=' + ip_addr + '&fields=sys_class_name,name,fqdn,sys_id,location,ip_address,support_group,support_group.manager&display_value=true'
